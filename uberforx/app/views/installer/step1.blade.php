        ...
        <div class="col-lg-8"  style="min-height:350px;">
          ...
          <form role="form" method="POST" action="{{ web_url(); }}/install">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="website_title" placeholder="Name of your App" value="{{ Session::get('website_title'); }}">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">Domain</label>
			    <input type="text" class="form-control"  name="url" placeholder="Domain name" value="{{ Session::get('url'); }}">
			  </div>
			  <div class="form-group">
...
$(function() {
    $( "#timezone" ).val("{{ Session::get('timezone') ? Session::get('timezone') : 'UTC'; }}");
});
</script>
@stop 